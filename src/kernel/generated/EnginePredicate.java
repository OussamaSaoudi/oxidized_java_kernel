...
public class EnginePredicate {
    ...
    public static class visitor {
        ...
        private static final MethodHandle UP$MH = delta_kernel_ffi_h.upcallHandle(visitor.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(visitor.Function fi, Arena arena) {
