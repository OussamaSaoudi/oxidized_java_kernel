...
/**
 * {@snippet lang=c :
 * typedef void (*VisitUnaryFn)(void *, uintptr_t, uintptr_t)
 * }
 */
public class VisitUnaryFn {
    ...
    private static final MethodHandle UP$MH = delta_kernel_ffi_h.upcallHandle(VisitUnaryFn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(VisitUnaryFn.Function fi, Arena arena) {
