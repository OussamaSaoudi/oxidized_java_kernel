...
public class FileMeta {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        KernelStringSlice.layout().withName("path"),
        delta_kernel_ffi_h.C_LONG_LONG.withName("last_modified"),
        delta_kernel_ffi_h.C_LONG.withName("size")
    ).withName("FileMeta");
    ...
    private static final long last_modified$OFFSET = 16;
