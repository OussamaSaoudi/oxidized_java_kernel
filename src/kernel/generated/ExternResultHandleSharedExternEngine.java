...
public class ExternResultHandleSharedExternEngine {
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$325:3"), groupElement("$anon$326:5"), groupElement("ok"));
    ...
    private static final AddressLayout err$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$325:3"), groupElement("$anon$329:5"), groupElement("err"));
