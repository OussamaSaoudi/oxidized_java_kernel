...
/**
 * {@snippet lang=c :
 * struct ExternResultHandleSharedScan {
 ...
 * }
 */
public class ExternResultHandleSharedScan {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1037:5"),
            MemoryLayout.structLayout(
                delta_kernel_ffi_h.C_POINTER.withName("err")
            ).withName("$anon$1040:5")
        ).withName("$anon$1036:3")
    ).withName("ExternResultHandleSharedScan");
    ...
    private static final AddressLayout ok$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$1036:3"), groupElement("$anon$1037:5"), groupElement("ok"));
    ...
    private static final AddressLayout err$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$1036:3"), groupElement("$anon$1040:5"), groupElement("err"));
