...
/**
 * {@snippet lang=c :
 * struct ExternResultKernelRowIndexArray {
 ...
 * }
 */
public class ExternResultKernelRowIndexArray {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1189:5"),
            MemoryLayout.structLayout(
                delta_kernel_ffi_h.C_POINTER.withName("err")
            ).withName("$anon$1192:5")
        ).withName("$anon$1188:3")
    ...
    private static final GroupLayout ok$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1188:3"), groupElement("$anon$1189:5"), groupElement("ok"));
    ...
    private static final AddressLayout err$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$1188:3"), groupElement("$anon$1192:5"), groupElement("err"));
